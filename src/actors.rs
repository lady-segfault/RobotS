...
pub trait Actor<M: Copy + Send + 'static + Reflect>: Send + Sized {
    ...
    ///     fn receive<Args: Copy  + Send + 'static>
    ...
    ///     }
    /// }
    fn receive<Args: Copy  + Send + 'static>(&self, message: M, context: ActorCell<Args, M, Self>);
