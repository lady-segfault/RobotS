...
impl ActorSystem {
    ...
    pub fn actor_of<Args: Copy  + Send + 'static, M: Copy  + Send + 'static + Reflect, A: Actor<M> + 'static>(&self, props: Props<Args, M, A>) -> ActorRef<Args, M, A> {
    ...
    pub fn enqueue_actor<Args: Copy  + Send + 'static, M: Copy  + Send + 'static + Reflect, A: Actor<M> + 'static>(&self, actor_ref: ActorRef<Args, M, A>) {
